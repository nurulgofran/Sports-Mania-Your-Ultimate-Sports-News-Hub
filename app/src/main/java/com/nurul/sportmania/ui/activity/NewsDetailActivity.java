...
import com.nurul.sportmania.data.local.FavoritesDatabaseHelper;
...
public class NewsDetailActivity extends AppCompatActivity {
    ...
    int layout,total_news, current= AppConstants.LIMIT_LATEST, view_news=AppConstants.LIMIT_LATEST;
   ...
   // private AdView adView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new FavoritesDatabaseHelper(this);
        ...
        if(saving_data){
            if(pref.loadNightModeState()){
                UiUtils.LoadNightSavingImage(thumbnail,this);
            }else{
                UiUtils.LoadDaySavingImage(thumbnail,this);
            }
        }else{
            if(pref.loadNightModeState()){
                UiUtils.LoadNightImage(thumbnail, image,this);
            }else{
                UiUtils.LoadDayImage(thumbnail, image,this);
            }
        }
        /// LOAD IMAGE
        ...
        if (NetworkUtils.checkConnection(this)) {
            ...
            btnEmojiLol.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(helper.getCountEmojiesById(nid) > 0){
                        UiUtils.Message(getApplicationContext(), pref.loadUser("YouHavaRated"));
                    }else{
                        ...
                        }else{ UiUtils.Message(getApplicationContext(), pref.loadUser("InternetError"));}
                    }
                }
            });
            // Button Emoji Loved
                ...
                public void onClick(View v) {
                    if(helper.getCountEmojiesById(nid) > 0){
                        ...
                        if (NetworkUtils.checkConnection(getApplicationContext())) {
                            ...
                            UiUtils.Message(getApplicationContext(), pref.loadUser("InternetError"));
                        }
                    }
            ...
            UiUtils.Message(getApplicationContext(), getResources().getString(R.string.internet_error));
        }
    ...
    private void LoadNewsDetail(){
        ...
        call.enqueue(new Callback<Details>() {
            ...
            public void onResponse(retrofit2.Call<Details> call, Response<Details> response) {
                ...
                if (pref.loadNightModeState()){
                    webView.loadData(UiUtils.HTMLTemplateDark(news_description), "text/html; charset=utf-8", "utf-8");
                }else{
                    webView.loadData(UiUtils.HTMLTemplateLight(news_description), "text/html; charset=utf-8", "utf-8");
                }
            ...
            public void onFailure(retrofit2.Call<Details> call, Throwable t) {
                if (t.toString().contains("SocketTimeoutException")) {
                    UiUtils.Write(t.getMessage(), "NewsDetailActivity");
                    UiUtils.Message(getApplicationContext(), pref.loadUser("TimeoutError"));
                    pb_fragment_home.setVisibility(View.GONE);
                } else {
                    UiUtils.Write(t.getMessage(), "NewsDetailActivity");
                    // UiUtils.Message(getApplicationContext(), getResources().getString(R.string.something_went_wrong));
                    pb_fragment_home.setVisibility(View.GONE);
                }
            }
        });
    ...
    private void updateEmoji(String Lol,String Loved,String Omg,String Funny,String Fail){
        ...
        call.enqueue(new Callback<Emojies>() {
            ...
            public void onResponse(retrofit2.Call<Emojies> call, Response<Emojies> response) {
                ...
                if(status == 1){
                    UiUtils.Message(getApplicationContext(), pref.loadUser("Succesfull"));
                    AddEmoji();
                }else{
                    UiUtils.Message(getApplicationContext(), pref.loadUser("Error"));
                }
