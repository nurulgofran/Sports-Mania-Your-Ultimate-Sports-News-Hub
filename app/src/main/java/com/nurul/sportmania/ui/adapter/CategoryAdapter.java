...
import com.nurul.sportmania.ui.activity.NewsCategoryActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final CategoryAdapter.ViewHolder viewHolder, final int i) {
        final String imageUrl = AppConstants.BASE_URL+AppConstants.IMG_URL+category.get(i).getCategory_image();
