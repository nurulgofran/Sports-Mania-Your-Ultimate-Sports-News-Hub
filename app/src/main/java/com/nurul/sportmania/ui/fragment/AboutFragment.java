...
public class AboutFragment extends Fragment implements FragmentInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (pref.loadNightModeState()){
            wb_description.loadData(UiUtils.HTMLTemplateDark(pref.loadUser("AppDescription")), "text/html; charset=utf-8", "utf-8");
        }else{
            wb_description.loadData(UiUtils.HTMLTemplateLight(pref.loadUser("AppDescription")), "text/html; charset=utf-8", "utf-8");
        }
